...
* Next, another message will appear asking to choose between 3 and 5.
	- if you input other numbers the machine will sent you a message and exit the program. 
	- once done with the input press enter you will see the output.